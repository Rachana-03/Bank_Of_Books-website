        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    ...
                    {
                        dr = dt.NewRow();
                        String mycon = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\ADMIN\source\repos\Project1\Project1\App_Data\demo.mdf;Integrated Security=True";
                        SqlConnection scon = new SqlConnection(mycon);
                        scon.Open();
                        String myquery = "select * from prod where ProductID=" + Request.QueryString["id"];
